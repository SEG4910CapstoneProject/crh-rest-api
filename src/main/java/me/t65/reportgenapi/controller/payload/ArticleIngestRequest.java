...
public class ArticleIngestRequest {
    ...
    @Schema(
            description = "Direct link (URL) to the article",
            example =
                    "https://www.cshub.com/threat-defense/articles/cyber-security-experts-fight-ai-generated-threats")
    private String link;
    ...
    @Schema(description = "Date the article was originally published", example = "2024-10-05")
